...
if (!isset($_SESSION['librerian_login'])) {
    ...
    $librerian_login_data = $_SESSION['librerian_username'];
    $data = mysqli_query($conn, "SELECT * FROM `librerian` WHERE `username` = '$librerian_login_data' ");
    $librerian_info = mysqli_fetch_assoc($data);
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= ucwords($librerian_info['firstname'].' '.$librerian_info['lastname']); ?></span>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?= $page == 'return-books.php' ? 'active-item' : '' ?>"><a href="return-books.php"><i class="fa fa-book" aria-hidden="true"></i><span>Return book</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
